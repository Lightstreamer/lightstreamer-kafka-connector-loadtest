...
For the Lightstreamer Kafka Connector case, the `ClientSimulator` of the Load Test Toolkit was used, specifying the following in the configuration and ditributing the load across the client machines up to 20,000 clients per machine:
```xml
    <param name="protocol">ws://</param>
    <param name="host">localhost</param>
    <param name="port">8080</param>
