...
public class JsonVeryComplexProducerWithJsonKey extends BaseProducer {
    ...
    public JsonVeryComplexProducerWithJsonKey(String kafka_bootstrap_string, String pid, String topicname, int pause, int msgsize,
    ...
    public void run() {
        ...
        try {
            Producer<KeyObj, TestVeryComplexObj> producer = new KafkaProducer<>(props);

            // Invia un primo messaggio per ogni key in stringids
            ...
            // Schedula l'invio periodico dei messaggi
            ...
            scheduler.scheduleAtFixedRate(() -> {
                ...
                try {
                    ...
                    synchronized (messages) {
                        ...
                        // Aggiorna il messaggio in base all'indice
                    ...
                    logger.error("Error during scheduled task: {}", e.getMessage());
                }
            }, 0, millisp, TimeUnit.MILLISECONDS);

        } catch (Exception e) {
            logger.error("Error during producer initialization: {}", e.getMessage());
            e.printStackTrace();
        }
    }
