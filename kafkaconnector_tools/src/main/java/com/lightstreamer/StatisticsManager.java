...
public class StatisticsManager {
    ...
    public StatisticsManager() {
        ...
        latencyLogger.info("The latency for each update is calculated as the difference between the " +
                "timestamp of when the update is processed by the Client and the timestamp of when " +
                "the update is generated by the producer.\n The best practice is to run an instance of the Client Simulator "
                +
                "with a small number of sessions (perhaps on the same machine of the prodcer) to sample " +
