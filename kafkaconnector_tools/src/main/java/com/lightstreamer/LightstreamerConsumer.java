...
public class LightstreamerConsumer {
    ...
    public static void main(String[] args) {
        LightstreamerClient client = new LightstreamerClient(
                "http://ec2-3-255-226-17.eu-west-1.compute.amazonaws.com:8080/", "KafkaConnector");
        ...
        String[] items = { "jsontest-[key=Charles]", "jsontest-[key=James]", "jsontest-[key=Michael]" };
        // String item = "ltest";
        ...
        String[] fields = { "key", "firstText", "secondText", "thirdText", "fourthText", "firstnumber",
